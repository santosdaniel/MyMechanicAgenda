...
/**
 * Represents one document of the vehicle or of the intervention
 */
...
class Document : GenericEntity(), Serializable {
    ...
    /**
     * The intervention which the document belongs
     */
    @ForeignKeyReference(columnName = INTERVENTION_COLUMN_NAME, foreignKeyColumnName = GenericEntity.ID_COLUMN_NAME)
    ...
    companion object {
        ...
        private const val INTERVENTION_COLUMN_NAME = "intervention"
